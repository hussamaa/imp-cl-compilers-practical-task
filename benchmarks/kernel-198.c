// --atomics 56 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 2,63,55 -l 1,1,1
#define int64_t long
...
int32_t  func_1(struct S5 * p_2)
{ /* block id: 4 */
    return p_2->l_comm_values[(safe_mod_func_uint32_t_u_u(p_2->tid, 1))];
}
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S5 c_4 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 1)), permutations[0][get_linear_local_id()])), // p_2->tid
    ...
    transparent_crc(p_2->g_comm_values[get_linear_group_id() * 1 + get_linear_local_id()], "p_2->g_comm_values[get_linear_group_id() * 1 + get_linear_local_id()]", print_hash_value);
