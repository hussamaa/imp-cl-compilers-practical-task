// --atomics 50 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 66,91,1 -l 2,1,1
#define int64_t long
...
int64_t  func_1(struct S0 * p_7);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : p_7->g_4 p_7->l_comm_values p_7->g_comm_values
 * writes: p_7->g_4
 */
int64_t  func_1(struct S0 * p_7)
{ /* block id: 4 */
    ...
    int32_t *l_3 = &p_7->g_4;
    (*l_3) &= (-1L);
    (*l_3) = (safe_sub_func_int16_t_s_s(p_7->l_comm_values[(safe_mod_func_uint32_t_u_u(p_7->tid, 2))], (p_7->g_comm_values[p_7->tid] , (*l_3))));
    return (*l_3);
}
