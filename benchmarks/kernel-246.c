// --atomics 36 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 11,53,9 -l 11,1,1
#define int64_t long
...
{5,0,3,1,6,4,9,10,7,8,2}, // permutation 0
{4,3,9,6,2,1,8,0,7,10,5}, // permutation 1
{8,2,5,9,1,0,3,7,10,4,6}, // permutation 2
{4,8,2,10,7,0,3,9,6,1,5}, // permutation 3
{2,5,10,3,8,7,4,9,6,0,1}, // permutation 4
{9,2,4,1,7,5,0,8,6,10,3}, // permutation 5
{10,0,6,8,4,2,9,3,5,1,7}, // permutation 6
{10,8,0,1,3,4,7,9,6,2,5}, // permutation 7
{2,10,8,4,7,0,5,6,9,1,3}, // permutation 8
{10,5,6,0,4,9,2,3,7,8,1} // permutation 9
};
