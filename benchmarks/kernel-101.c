// --atomics 36 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 59,45,2 -l 1,5,2
#define int64_t long
...
{2,3,5,0,7,8,6,1,9,4}, // permutation 0
{6,2,7,8,5,9,1,4,3,0}, // permutation 1
{2,0,5,8,4,3,9,7,1,6}, // permutation 2
{8,0,3,5,2,1,6,7,9,4}, // permutation 3
{9,5,0,2,4,3,1,8,7,6}, // permutation 4
{8,4,1,7,0,2,9,6,5,3}, // permutation 5
{9,6,8,5,2,0,3,4,1,7}, // permutation 6
{5,0,2,1,9,7,8,6,3,4}, // permutation 7
{6,5,8,3,2,0,7,4,9,1}, // permutation 8
{3,7,4,9,6,8,0,2,5,1} // permutation 9
};
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S3 c_4 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 10)), permutations[0][get_linear_local_id()])), // p_2->tid
    ...
    transparent_crc(p_2->g_comm_values[get_linear_group_id() * 10 + get_linear_local_id()], "p_2->g_comm_values[get_linear_group_id() * 10 + get_linear_local_id()]", print_hash_value);
