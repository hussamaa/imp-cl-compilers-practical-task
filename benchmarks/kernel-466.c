// --atomics 93 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 72,61,1 -l 3,1,1
#define int64_t long
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S2* p_4 = &c_5;
    struct S2 c_6 = {
        {65530UL,0x61L,0x61BAB593L,-1L}, // p_4->g_2
        0, // p_4->v_collective
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 3)), permutations[0][get_linear_local_id()])), // p_4->tid
    ...
    transparent_crc(p_4->g_comm_values[get_linear_group_id() * 3 + get_linear_local_id()], "p_4->g_comm_values[get_linear_group_id() * 3 + get_linear_local_id()]", print_hash_value);
