// --atomics 6 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 46,59,3 -l 2,1,1
#define int64_t long
...
int32_t * func_5(int64_t  p_6, struct S0 * p_10);


/* --- FUNCTIONS --- */
/* ------------------------------------------ */
/* 
 * reads : p_10->g_2 p_10->g_comm_values p_10->g_7
 * writes: p_10->g_2 p_10->g_8
 */
uint16_t  func_1(struct S0 * p_10)
{ /* block id: 4 */
    int32_t l_9 = 8L;
    for (p_10->g_2[1] = (-24); (p_10->g_2[1] < (-14)); ++p_10->g_2[1])
    { /* block id: 7 */
        (*p_10->g_7) = func_5(p_10->g_comm_values[p_10->tid], p_10);
    }
    return l_9;
}
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S0* p_10 = &c_11;
    struct S0 c_12 = {
        {0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL,0x2BECBA2AL}, // p_10->g_2
        &p_10->g_2[1], // p_10->g_8
        &p_10->g_8, // p_10->g_7
        0, // p_10->v_collective
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 2)), permutations[0][get_linear_local_id()])), // p_10->tid
    ...
    for (i = 0; i < 9; i++)
    {
        transparent_crc(p_10->g_2[i], "p_10->g_2[i]", print_hash_value);
    ...
    transparent_crc(p_10->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()], "p_10->g_comm_values[get_linear_group_id() * 2 + get_linear_local_id()]", print_hash_value);
