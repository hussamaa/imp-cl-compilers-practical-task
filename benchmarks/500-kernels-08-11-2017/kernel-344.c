// --atomics 12 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 38,100,2 -l 1,2,2
#define int64_t long
...
{3,0,2,1}, // permutation 3
{2,0,1,3}, // permutation 4
{2,3,1,0}, // permutation 5
{1,0,2,3}, // permutation 6
{1,0,3,2}, // permutation 7
{2,3,1,0}, // permutation 8
{1,0,2,3} // permutation 9
};
...
{ /* block id: 4 */
    int32_t *l_2 = &p_4->g_3;
    (*l_2) &= p_4->l_comm_values[(safe_mod_func_uint32_t_u_u(p_4->tid, 4))];
    return (*l_2);
}
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S5 c_6 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 4)), permutations[0][get_linear_local_id()])), // p_4->tid
    ...
    transparent_crc(p_4->g_comm_values[get_linear_group_id() * 4 + get_linear_local_id()], "p_4->g_comm_values[get_linear_group_id() * 4 + get_linear_local_id()]", print_hash_value);
