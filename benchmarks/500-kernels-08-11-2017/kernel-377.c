// --atomics 50 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 99,37,1 -l 11,1,1
#define int64_t long
...
{10,6,9,2,7,1,3,5,4,0,8}, // permutation 0
{1,6,2,5,7,4,8,9,10,0,3}, // permutation 1
{3,0,10,4,6,5,9,2,8,1,7}, // permutation 2
{1,5,6,10,3,8,7,4,0,2,9}, // permutation 3
{1,5,9,6,8,10,2,4,0,7,3}, // permutation 4
{1,9,10,0,7,3,4,2,8,6,5}, // permutation 5
{1,0,5,9,3,2,4,8,10,7,6}, // permutation 6
{1,4,7,9,5,8,2,3,10,6,0}, // permutation 7
{2,10,9,6,7,1,8,5,3,4,0}, // permutation 8
{4,3,5,2,1,8,10,0,7,9,6} // permutation 9
};
