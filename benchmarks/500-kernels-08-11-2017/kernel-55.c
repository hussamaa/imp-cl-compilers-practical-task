// --atomics 33 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 72,45,2 -l 6,1,1
#define int64_t long
...
{1,0,2,5,4,3}, // permutation 0
{0,4,2,5,1,3}, // permutation 1
{2,5,1,0,4,3}, // permutation 2
{4,5,2,3,1,0}, // permutation 3
{4,0,3,2,1,5}, // permutation 4
{1,4,3,5,0,2}, // permutation 5
{1,3,5,2,4,0}, // permutation 6
{2,3,1,4,5,0}, // permutation 7
{4,3,2,5,1,0}, // permutation 8
{1,2,5,4,0,3} // permutation 9
};
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S1 c_4 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 6)), permutations[0][get_linear_local_id()])), // p_2->tid
    ...
    transparent_crc(p_2->g_comm_values[get_linear_group_id() * 6 + get_linear_local_id()], "p_2->g_comm_values[get_linear_group_id() * 6 + get_linear_local_id()]", print_hash_value);
