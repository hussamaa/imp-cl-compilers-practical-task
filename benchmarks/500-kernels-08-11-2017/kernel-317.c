// --atomics 11 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 68,45,3 -l 1,1,1
#define int64_t long
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S1 c_7 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 1)), permutations[0][get_linear_local_id()])), // p_5->tid
    ...
    transparent_crc(p_5->g_comm_values[get_linear_group_id() * 1 + get_linear_local_id()], "p_5->g_comm_values[get_linear_group_id() * 1 + get_linear_local_id()]", print_hash_value);
