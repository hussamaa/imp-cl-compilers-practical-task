// --atomics 7 ---atomic_reductions ---fake_divergence ---inter_thread_comm -g 10,51,16 -l 2,1,2
#define int64_t long
...
{3,0,2,1}, // permutation 0
{1,3,2,0}, // permutation 1
{1,2,0,3}, // permutation 2
{1,0,3,2}, // permutation 3
{1,2,3,0}, // permutation 4
{1,3,2,0}, // permutation 5
{2,3,1,0}, // permutation 6
{1,3,0,2}, // permutation 7
{1,2,3,0}, // permutation 8
{1,2,3,0} // permutation 9
};
...
__kernel void entry(__global ulong *result, __global volatile uint *g_atomic_input, __global volatile uint *g_special_values, __global volatile int *g_atomic_reduction, __global int *sequence_input, __global long *g_comm_values) {
    ...
    struct S4 c_5 = {
        ...
        (safe_add_func_uint32_t_u_u((safe_mul_func_uint32_t_u_u(get_linear_group_id(), 4)), permutations[0][get_linear_local_id()])), // p_3->tid
    ...
    transparent_crc(p_3->g_comm_values[get_linear_group_id() * 4 + get_linear_local_id()], "p_3->g_comm_values[get_linear_group_id() * 4 + get_linear_local_id()]", print_hash_value);
